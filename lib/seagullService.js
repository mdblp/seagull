...
function createServer(serverConfig, crudHandler, userApiClient, gatekeeperClient, metrics) {
  ...
  var seagullApi = require('./routes/seagullApi')(crudHandler, userApiClient, gatekeeperClient, metrics, serverConfig);
...
module.exports = function seagullService(envConfig, crudHandler, userApiClient, gatekeeperClient, metrics) {
  ...
  if (envConfig.httpPort != null) {
    ...
    server = createServer(
      { name: 'SeagullHttp' , appVersion: envConfig.metricsVersion },
      crudHandler,
      userApiClient,
      gatekeeperClient,
      metrics
  ...
  if (envConfig.httpsPort != null) {
    ...
    server = createServer(
      _.extend({ name: 'SeagullHttps', appVersion: envConfig.metricsVersion  },
